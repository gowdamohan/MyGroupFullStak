...
export default function RegionalLoginPage() {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      console.log('🔍 Regional Login Success Data:', data);
      ...
      toast({
        title: "Regional Login Successful",
    ...
    onError: (error: any) => {
      toast({
        title: "Regional Login Failed",
        description: error.message || "Invalid regional credentials",
        variant: "destructive",
      });
    }
  });
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center" style={{ background: 'linear-gradient(135deg, #27ae60 0%, #2ecc71 100%)' }}>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card glass-modal border-0 shadow-lg">
              <div className="card-header border-0 text-center bg-transparent">
                <h3 className="text-white fw-bold mb-0" data-testid="regional-login-title">
                  <i className="bi bi-geo-alt-fill me-2 text-success"></i>
                  Regional Access
                </h3>
                <p className="text-white-50 mt-2 mb-0">Regional User Login</p>
              </div>
              
              <div className="card-body p-4">
                <form onSubmit={handleSubmit} data-testid="form-regional-login">
                  <div className="mb-3">
                ...
                <div className="mt-4 pt-4 border-top border-white-50">
                  <h6 className="text-white text-center mb-3">Demo Regional User</h6>
                  <div className="text-white-50 small text-center">
                    <p className="mb-1"><strong>Username:</strong> regional</p>
