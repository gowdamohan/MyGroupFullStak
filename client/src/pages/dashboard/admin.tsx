...
export default function AdminDashboard() {
  ...
  const menuItems = [
    { icon: 'bi-speedometer2', label: 'Dashboard', path: '/dashboard/admin', active: true },
    {
      ...
      label: 'Profile',
      subItems: [
        { icon: 'bi-people', label: 'Group', path: '/dashboard/admin/profile/group' },
        { icon: 'bi-app', label: 'App Created', path: '/dashboard/admin/profile/app-created' },
        { icon: 'bi-key', label: 'Change Password', path: '/dashboard/admin/profile/change-password' }
      ]
    },
    {
      icon: 'bi-geo-alt',
      label: 'Location',
      subItems: [
        { icon: 'bi-file-text', label: 'Content', path: '/dashboard/admin/location/content' },
        { icon: 'bi-globe', label: 'Country', path: '/dashboard/admin/location/country' },
        { icon: 'bi-map', label: 'State', path: '/dashboard/admin/location/state' },
        { icon: 'bi-pin-map', label: 'District', path: '/dashboard/admin/location/district' }
      ]
    },
    { icon: 'bi-translate', label: 'Language', path: '/dashboard/admin/language' },
    { icon: 'bi-mortarboard', label: 'Education', path: '/dashboard/admin/education' },
