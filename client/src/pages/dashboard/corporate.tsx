...
export default function CorporateDashboard() {
  ...
  const menuItems = [
    ...
    { icon: 'bi-award', label: 'Awards', path: '/dashboard/corporate/awards' },
    { icon: 'bi-newspaper', label: 'Newsroom', path: '/dashboard/corporate/newsroom' },
    { icon: 'bi-calendar-event', label: 'Events', path: '/dashboard/corporate/events' },
    { icon: 'bi-briefcase', label: 'Careers', path: '/dashboard/corporate/careers' },
    { icon: 'bi-people-fill', label: 'Clients', path: '/dashboard/corporate/clients' },
    { icon: 'bi-trophy', label: 'Milestones', path: '/dashboard/corporate/milestones' },
    { icon: 'bi-chat-quote', label: 'Testimonials', path: '/dashboard/corporate/testimonials' },
    ...
    { icon: 'bi-shield-check', label: 'Privacy Policy', path: '/dashboard/corporate/privacy-policy' },
    { icon: 'bi-database', label: 'Public Database', path: '/dashboard/corporate/public-database' },
    { icon: 'bi-file-earmark-text', label: 'Applications', path: '/dashboard/corporate/applications' },
    { icon: 'bi-chat-dots', label: 'Feedback & Support', path: '/dashboard/corporate/feedback' },
