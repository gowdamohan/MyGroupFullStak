...
export default function CorporateLoginPage() {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      console.log('🔍 Corporate Login Success Data:', data);
    ...
    onError: (error: any) => {
      toast({
        title: "Corporate Login Failed",
        description: error.message || "Invalid corporate credentials",
        variant: "destructive",
      });
    }
  });
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card glass-modal border-0 shadow-lg">
              <div className="card-header border-0 text-center bg-transparent">
                <h3 className="text-white fw-bold mb-0" data-testid="corporate-login-title">
                  <i className="bi bi-building-fill me-2 text-info"></i>
                  Corporate Access
                </h3>
                <p className="text-white-50 mt-2 mb-0">Corporate User Login</p>
              </div>
              
              <div className="card-body p-4">
                <form onSubmit={handleSubmit} data-testid="form-corporate-login">
                  <div className="mb-3">
                ...
                <div className="mt-4 pt-4 border-top border-white-50">
                  <h6 className="text-white text-center mb-3">Demo Corporate User</h6>
                  <div className="text-white-50 small text-center">
                    <p className="mb-1"><strong>Username:</strong> corporate</p>
